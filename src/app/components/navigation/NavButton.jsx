          ...
          >
            ...
            >
              <span className="relative w-14 h-14 p-4 group-hover:pause hover:text-accent animate-spin-slow-reverse">
                ...
                {/* Icon K naam wala span hay neechay */}
        ...
        "
            ...
            >
              <span className="relative w-10 h-10 xs:w-14 xs:h-14 p-2.5 xs:p-4 hover:text-accent ">
                ...
                <span
                  className={clsx(
                    "absolute hidden peer-hover:block px-2 py-2 left-full mx-2 top-1/2 -translate-y-1/2 bg-background text-foreground text-sm rounded-md shadow-lg whitespace-nowrap",
